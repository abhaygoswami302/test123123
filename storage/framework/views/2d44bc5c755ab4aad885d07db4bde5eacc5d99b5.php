...
} elseif ($_instance->childHasBeenRendered('GARNIKj')) {
    $componentId = $_instance->getRenderedChildComponentId('GARNIKj');
    $componentTag = $_instance->getRenderedChildComponentTagName('GARNIKj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GARNIKj');
} else {
    $response = \Livewire\Livewire::mount('bookmark', ['product' => $product]);
    $html = $response->html();
    $_instance->logRenderedChild('GARNIKj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                        <div class="col-sm-12">
...
<?php echo $__env->make('layouts.productindexapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/guest/products/index2.blade.php ENDPATH**/ ?>