<div class="col-sm-8">
    ...
    <?php else: ?>
    <form action="<?php echo e(route('user.lego.minifigures.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row px-4">
...
<?php /**PATH C:\xampp\htdocs\ucc\resources\views/livewire/user-lego-mini-figures.blade.php ENDPATH**/ ?>