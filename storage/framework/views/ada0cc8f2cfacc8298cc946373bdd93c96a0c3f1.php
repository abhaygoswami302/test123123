        ...
        <div class="col-sm-12">
            <div class="row p-2">
                <div class="col-sm-12 text-center">
                    <h3 class="m-0 font-weight-bold text-primary">Clear Databaes OTP</h3>
                    <p>
                        <small>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/admin/clearProducts/index.blade.php ENDPATH**/ ?>