...
} elseif ($_instance->childHasBeenRendered('5Vownfq')) {
    $componentId = $_instance->getRenderedChildComponentId('5Vownfq');
    $componentTag = $_instance->getRenderedChildComponentTagName('5Vownfq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5Vownfq');
} else {
    $response = \Livewire\Livewire::mount('bookmark', ['product' => $product]);
    $html = $response->html();
    $_instance->logRenderedChild('5Vownfq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                        <div class="col-sm-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/guest/products/index.blade.php ENDPATH**/ ?>