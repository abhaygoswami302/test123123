    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
        ...
        <?php if(count($products) > 0): ?>
            ...
            <ul style="position:absolute; z-index:99999; width:400px; background:white; box-shadow:#8ca5f0 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 5px 5px;">
                ...
                <li style="">
                    <a href="<?php echo e(route('editor_products.show', $product->id)); ?>" style="color: black;text-decoration:none;">
...
</div><?php /**PATH C:\xampp\htdocs\ucc\resources\views/livewire/editor-front-search.blade.php ENDPATH**/ ?>