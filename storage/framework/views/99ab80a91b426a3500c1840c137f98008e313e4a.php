            ...
            <ul style="position:absolute; z-index:99999; width:400px; background:white; box-shadow:#8ca5f0 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 5px 5px;">
                ...
                <?php if(count($categories) > 0): ?>
                    <li style="background:white;" class="p-2">
                        <p style="padding: 2%" class="alert alert-primary"><b><?php echo e(count($categories)); ?> Categories Results</b></p>
                    </li>

                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li style="">
                        <a href="<?php echo e(route('admin_categories.show', $category->id)); ?>" style="color: black;text-decoration:none;">
                            <div class="row" style="background: white;padding:0px;margin:0px">
                                ...
                                <div class="col-sm-12">
                                    <?php echo e(substr($category->description, 0, 60)); ?>
                ...
                <li style="">
                    <a href="<?php echo e(route('admin_products.show', $product->id)); ?>" style="color: black;text-decoration:none;">
                        <div class="row" style="background: white;padding:0px;margin:0px">
                            <div class="col-sm-8">
...
</div><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/livewire/admin-front-search.blade.php ENDPATH**/ ?>