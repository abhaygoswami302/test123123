        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 p-4">
                    ...
                    <h5><b>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</b></h5> <br>
                    ...
                    <p><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Ultimate Collections Company, PO Box 8021, Toowoomba South, QLD 4350, Australia.
                    ...
                    <p><b>Country</b> refers to: Queensland, Australia</p>
                    ...
                    <p><b>Facebook</b> Fan Page is a public profile named Ultimate Collections Company specifically created by the Company on the Facebook social network, accessible from https://www.facebook.com/ultimatecollectionscompany</p>
                    <p><b>Personal Data </b> is any information that relates to an identified or identifiable individual.
                    For the purposes of GDPR, Personal Data means any information relating to You such as a name, an identification number, location data, online identifier or to one or more factors specific to the physical, physiological, genetic, mental, economic, cultural or social identity.</p>
                    ...
                    <p>Website refers to Ultimate Collections Company, accessible from https://www.ultimatecollectionscompany.com/</p>
                    <p><b>You</b> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                        Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject or as the User as you are the individual using the Service.</p> <br>
    
                    <h3><b>Collecting and Using Your Personal Data</b></h3> <br>
                    <h4><b>Types of Data Collected</b></h4> <br>
                    <h5>Personal Data</h5>
                    <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
                    <p><b>Email address</b></p>
                    <p><b>First name and last name</b></p>
                    <p><b>Address, State, Province, ZIP/Postal code, City</b></p>
                    <p><b>Usage Data</b></p> <br>
                    ...
                    <h4><b>Tracking Technologies and Cookies</b></h4><br>
                    ...
                    <p><b>Purpose:</b> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                    ...
                    <h4><b>Retention of Your Personal Data</b></h4> <br>
                    ...
                    <h4><b>Transfer of Your Personal Data</b></h4><br>
                    ...
                    <h4><b>Disclosure of Your Personal Data</b></h4> <br>
                    ...
                    <h4><b>Other legal requirements</b></h4> <br>
                    ...
                    <h4><b>Security of Your Personal Data</b></h4> <br>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                    <h4><b>Detailed Information on the Processing of Your Personal Data</b></h4>
                    ...
                    <div>
                        <ul>
                            ...
                            <li><b>Legitimate interests:</b> Processing Personal Data is necessary for the purposes of the legitimate interests pursued by the Company.
                                In any case, the Company will gladly help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Data is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</li>
                        </ul>
                    </div>
                        
                    <h4><b>Your Rights under the GDPR</b></h4><br>
                    ...
                    <h4><b>Exercising of Your GDPR Data Protection Rights</b></h4> <br>
                    <p>You may exercise Your rights of access, rectification, cancellation and opposition by contacting Us. Please note that we may ask You to verify Your identity before responding to such requests. If You make a request, We will try our best to respond to You as soon as possible.</p>
                    <p>You have the right to complain to a Data Protection Authority about Our collection and use of Your Personal Data. For more information, if You are in the European Economic Area (EEA), please contact Your local data protection authority in the EEA.</p>
    
                    <h4><b>Facebook Fan Page</b></h4> <br>
                    <h5>Data Controller for the Facebook Fan Page</h5>
                    <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page https://www.facebook.com/ultimatecollectionscompany, the Company and the operator of the social network Facebook are Joint Controllers.</p>
                    ...
                    <h4><b>Facebook Insights</b></h4> <br>
                    <p>We use the Facebook Insights function in connection with the operation of the Facebook Fan Page and on the basis of the GDPR, in order to obtain anonymized statistical data about Our users.
                        For this purpose, Facebook places a Cookie on the device of the user visiting Our Facebook Fan Page. Each Cookie contains a unique identifier code and remains active for a period of two years, except when it is deleted before the end of this period.
                        Facebook receives, records and processes the information stored in the Cookie, especially when the user visits the Facebook services, services that are provided by other members of the Facebook Fan Page and services by other companies that use Facebook services.
                        For more information on the privacy practices of Facebook, please visit Facebook Privacy Policy here: https://www.facebook.com/privacy/explanation</p>
                    ...
                    <h4><b>Links to Other Websites</b></h4> <br>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/auth/documents/privacy_policy.blade.php ENDPATH**/ ?>