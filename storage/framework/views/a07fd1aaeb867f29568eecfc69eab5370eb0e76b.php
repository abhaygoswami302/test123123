                ...
                <h6 class="m-0 font-weight-bold text-primary">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <a href="<?php echo e(route('editor_products.edit', $product->id)); ?>">
                                <button class="btn btn-primary btn-sm">Edit <?php echo e($product->name); ?></button>
                            </a>                                
                            <?php endif; ?>
                            <?php if($product->collection_name == 'Lego MiniFigures'): ?>
                            <a href="<?php echo e(route('editor_lego_minifigures_form.edit', $product->id)); ?>">
                                <button class="btn btn-primary btn-sm">Edit <?php echo e($product->name); ?></button>
                            </a>                                
                            <?php endif; ?>
                            <?php if($product->collection_name == 'Hot Toys'): ?>
                            <a href="<?php echo e(route('editor_hot_toys.edit', $product->id)); ?>">
                                <button class="btn btn-primary btn-sm">Edit <?php echo e($product->name); ?></button>
                            </a>                                
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/editor/products/show.blade.php ENDPATH**/ ?>