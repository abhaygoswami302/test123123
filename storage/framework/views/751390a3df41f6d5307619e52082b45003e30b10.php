                        ...
                        <div class="ClctMnRtTpLft ">
                          <div class="TitleMn">
                            <ul class="breadcrumb" style="background: transparent">
                                ...
                                <li><a class="active" href="<?php echo e(route('users.dashboard')); ?>">Categories</a></li>
...
<?php echo $__env->make('layouts.users', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/user/categories/show.blade.php ENDPATH**/ ?>