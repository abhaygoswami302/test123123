                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a href="<?php echo e(route('contributor_lego_minifigures.edit', $product->id)); ?>"><i class="fas fa-edit"></i></a>
                                        </div>
...
<?php echo $__env->make('layouts.contributor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/contributor/lego_minifigures/index.blade.php ENDPATH**/ ?>