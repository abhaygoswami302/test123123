...
} elseif ($_instance->childHasBeenRendered('BIAtDFE')) {
    $componentId = $_instance->getRenderedChildComponentId('BIAtDFE');
    $componentTag = $_instance->getRenderedChildComponentTagName('BIAtDFE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BIAtDFE');
} else {
    $response = \Livewire\Livewire::mount('admin-front-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('BIAtDFE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                ...
                <!-- Counter - Messages -->
                <span class="badge badge-danger badge-counter"><?php echo e(count($nav_admin_feedbacks_count) + count($nav_admin_ss_count)); ?></span>
            </a>
            <!-- Dropdown - Messages -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <?php if(count($nav_admin_feedbacks) >= 1 || count($nav_admin_ss) > 1): ?>
                    ...
                    <?php $__currentLoopData = $nav_admin_ss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ss34343): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('product.feedback.index')); ?>">
                            <div class="font-weight-bold">
                                <div class="text-truncate"><?php echo e(substr($ss34343->collection, 0,20)); ?></div>
                                <div class="small text-gray-500">By : <?php echo e($ss34343->email); ?></div>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<!-- End of Topbar --><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/admin/partials/nav.blade.php ENDPATH**/ ?>