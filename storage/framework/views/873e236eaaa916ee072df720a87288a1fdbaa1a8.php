                ...
                <h6 class="m-0 font-weight-bold text-primary">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <a href="<?php echo e(route('contributor_lego_minifigures.edit', $product->id)); ?>">
                                <button class="btn btn-primary btn-sm">Edit <?php echo e($product->name); ?></button>
                            </a>
                            <a href="<?php echo e(route('contributor_lego_minifigures.index')); ?>">
                                <button class="btn btn-primary btn-sm">View All Hot Toys Products</button>
                            </a>                                
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.contributor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/contributor/products/show.blade.php ENDPATH**/ ?>