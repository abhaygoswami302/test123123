                    ...
                    <div class="FooterTp_1">
                        ...
                        <div class="FtrDsc">
                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0);"><i class="fas fa-chevron-right"></i> More</a></li>
                            </ul>
                            <?php else: ?>
                            <ul>
...
<script src="<?php echo e(asset('js/app.js')); ?>"></script>
<script src="<?php echo e(asset('js/menu.js')); ?>"></script>
<script src="<?php echo e(asset('js/all.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\ucc\resources\views/partials/users/footer.blade.php ENDPATH**/ ?>