        ...
        <div class="col-sm-12">
            <div class="row p-2">
                ...
                <div class="col-sm-6 text-center">
                    <h3 class="m-0 font-weight-bold text-primary">All Hot Wheels Products</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="row">
                                        <div class="col-sm-6 text-center">
                                            <a href="<?php echo e(route('contributor_products.edit', $product->id)); ?>"><i class="fas fa-edit"></i></a>
                                        </div>
                                        <div class="col-sm-6 text-center">
                                            <a href="<?php echo e(route('contributor_products.show', $product->id)); ?>"><i class="fas fa-paper-plane"></i></a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('contributor_products.show', $product->id)); ?>">
                                        <?php echo e($product->name); ?>

                                    </a>
                                </td>
                                <td>
                                        <?php echo e($product->series); ?>                                </td>
                                <td>
...
<?php echo $__env->make('layouts.contributor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/contributor/dashboard.blade.php ENDPATH**/ ?>