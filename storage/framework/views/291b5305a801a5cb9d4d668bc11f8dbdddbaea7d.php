                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a href="<?php echo e(route('editor_products.edit', $product->id)); ?>"><i class="fas fa-edit"></i></a>
                                        </div>
                                        <!--div class="col-sm-6 text-center p-0 m-0">
                                           <form action="<?php echo e(route('editor_products.destroy', $product->id)); ?>" method="POST">
                                               <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/editor/products/index.blade.php ENDPATH**/ ?>