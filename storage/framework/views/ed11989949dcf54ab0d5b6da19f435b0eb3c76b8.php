...
} elseif ($_instance->childHasBeenRendered('a7XGmTh')) {
    $componentId = $_instance->getRenderedChildComponentId('a7XGmTh');
    $componentTag = $_instance->getRenderedChildComponentTagName('a7XGmTh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a7XGmTh');
} else {
    $response = \Livewire\Livewire::mount('bookmark', ['product' => $s1]);
    $html = $response->html();
    $_instance->logRenderedChild('a7XGmTh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <div class="col-sm-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/guest/collections/collection_products.blade.php ENDPATH**/ ?>