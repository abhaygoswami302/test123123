...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 ">
            <h3 class="m-0 font-weight-bold text-primary">Edit Hot Toys Product</h3>
        </div>
        <div class="col-sm-6 text-right pb-4 ">
           <a href="<?php echo e(route('hotToys.create')); ?>">
            <button class="btn btn-primary btn-sm">Add New Hot Toys Product</button>
           </a>
           <a href="<?php echo e(route('hotToys.index')); ?>">
            <button class="btn btn-primary btn-sm">View All Hot Toys Product</button>
           </a>
        </div>
            ...
            <div class="row card shadow mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Edit Hot Toys Product
                    </h6>
                </div>
                <div class="card-body">
                    <div class="col-sm-12">
                        <form action="<?php echo e(route('hotToys.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row px-4">
                                ...
                                <div class="col-sm-4 p-1">
                                    ...
                                    <select name="subseries_name" id="subseries_name" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $subseries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sub->name); ?>" 
                                                <?php if($sub->name == $product->subseries_name): ?>
                                                    Selected
                                                <?php endif; ?>
                                ...
                                <div class="col-sm-4 p-1">
                                    ...
                                    <input type="text" name="model_name"  value="<?php echo e($product->model_name); ?>" class="form-control" required placeholder="Enter Model Name">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="year">Year</label>
                                    <input type="text" name="year"  value="<?php echo e($product->year); ?>" class="form-control" required placeholder="Enter Year">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="collection_name">Collection Name</label>
                                    <input type="text" name="collection_name" readonly value="<?php echo e($product->collection_name); ?>" class="form-control" required placeholder="Enter Collection Name">
                                </div>

                                <div class="col-sm-6 p-1">
                                    <label for="toy_hash">Toy Hash</label>
                                    <input type="text" name="toy_hash" value="<?php echo e($product->toy_hash); ?>" class="form-control" required placeholder="Enter Fig Num">
                                </div>
                                <div class="col-sm-6 p-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/admin/hottoys/products/edit.blade.php ENDPATH**/ ?>