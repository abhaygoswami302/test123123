...
} elseif ($_instance->childHasBeenRendered('DCgoc0e')) {
    $componentId = $_instance->getRenderedChildComponentId('DCgoc0e');
    $componentTag = $_instance->getRenderedChildComponentTagName('DCgoc0e');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DCgoc0e');
} else {
    $response = \Livewire\Livewire::mount('front-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('DCgoc0e', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
                ...
                <div class="Nav_Menu_Lft" id="cssmenu">
                    ...
                    <ul>
                        ...
                        <?php else: ?>
                            ...
                            <li class="MnLst"><a href="<?php echo e(route('guest.coming.soon')); ?>">Forum</a></li>
                            <li class="MnLst"><a href="<?php echo e(route('guest.coming.soon')); ?>">Marketplace</a></li>
                            <li class="MnLst"><a href="<?php echo e(route('guest.coming.soon')); ?>">Coming Soon</a></li>
                            <div class="DtpNon">
...
</nav><?php /**PATH C:\xampp\htdocs\ucc\resources\views/partials/guest/nav.blade.php ENDPATH**/ ?>