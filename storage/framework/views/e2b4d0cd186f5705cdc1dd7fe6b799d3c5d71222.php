                ...
                <div class="row">
                    <?php if($product->collection_name == 'Hot Wheels'): ?>
                        ...
                        <div class="col-sm-12 pb-2">
                            ...
                            <h5 class="py-1"><b>Notes : </b><?php echo $product->notes; ?> </h5>
                        </div>
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-sm-12">
                            <h5 class="py-1"><b>Subseries Name :</b> <a href="<?php echo e(route('byseries', $product->subseries_name)); ?>"> <?php echo e($product->subseries_name); ?> </a></h5>
                        </div>
                        <div class="col-sm-12">
                            <h5 class="py-1"><b>Collection Name :</b> <?php echo e($product->collection_name); ?> </h5>
                        </div>
                        <div class="col-sm-12">
                            <h5 class="py-1"><b>Year :</b> <a href="<?php echo e(route('byyear', $product->year)); ?>"> <?php echo e($product->year); ?> </a></h5>
                        </div>
                        <div class="col-sm-12">
                            <h5 class="py-1"><b>Notes :</b>  <?php echo substr($product->notes, 0, 200); ?>  
...
} elseif ($_instance->childHasBeenRendered('p2IbT2h')) {
    $componentId = $_instance->getRenderedChildComponentId('p2IbT2h');
    $componentTag = $_instance->getRenderedChildComponentTagName('p2IbT2h');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('p2IbT2h');
} else {
    $response = \Livewire\Livewire::mount('liked', ['product' => $product]);
    $html = $response->html();
    $_instance->logRenderedChild('p2IbT2h', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <!-- Modal -->
    <form action="<?php echo e(route('product.feedback.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="category_id" value="<?php echo e($product->category_id); ?>">
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <small>Notes : <?php echo $product->notes; ?></small>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/guest/products/show.blade.php ENDPATH**/ ?>