                        ...
                        <div class="ClctMnRtTpLft ">
                          <div class="TitleMn">
                            <ul class="breadcrumb" style="background: transparent">
                                ...
                                <li><a class="active" href="<?php echo e(route('usercollection.show', $collection->id)); ?>">
                                    Categories In <?php echo e($collection->name); ?></a></li>
...
<?php echo $__env->make('layouts.users', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/user/collections/collection_products.blade.php ENDPATH**/ ?>