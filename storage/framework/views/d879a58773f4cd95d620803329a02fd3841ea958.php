						...
						<!--p>Total <b>2</b> Collections | <b>2</b>  in this page</p-->
                            ...
                            <div class="col-xl-12 text-center">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a class="active" href="<?php echo e(route('collection.index')); ?>"><?php echo e($collection->name); ?></a></li>
                                    <li><a class="active" href="<?php echo e(route('collection.show', $collection->id)); ?>">Categories</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php echo e(substr($category->description, 0, 30)); ?>...                        
                    <?php endif; ?>
                </div>
            </div>
                ...
                <?php $__currentLoopData = $subseries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="product" id="<?php echo e($s1->name); ?>_<?php echo e($s1->id); ?>">
                            <div class="imgbox">
                                <?php if($s1->image1 == NULL): ?>
                                    <img src="<?php echo e(asset('images/car_not_found.jpg')); ?>" alt="">
                                <?php else: ?>
                                <img src="<?php echo e(asset($s1->image1)); ?>" >                                        
                                <?php endif; ?> 
                            </div>
                            <!--div class="specifies">
...
} elseif ($_instance->childHasBeenRendered('QBtz9MA')) {
    $componentId = $_instance->getRenderedChildComponentId('QBtz9MA');
    $componentTag = $_instance->getRenderedChildComponentTagName('QBtz9MA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QBtz9MA');
} else {
    $response = \Livewire\Livewire::mount('bookmark', ['product' => $s1]);
    $html = $response->html();
    $_instance->logRenderedChild('QBtz9MA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    <div class="col-sm-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/guest/collections/collection_products.blade.php ENDPATH**/ ?>