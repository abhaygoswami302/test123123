    ...
    <div class="row">
        ...
        <div class="col-xl-12 ">
            <div class="row card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        <form action="<?php echo e(route('contributor_lego_minifigures.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <div class="row px-4">
                                <div class="col-sm-4 p-1">
                                    <input type="text" readonly name="name"  value="<?php echo e($product->name); ?>" class="form-control" required placeholder="Enter Product Name">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <input type="text" readonly name="fig_num"  value="<?php echo e($product->lego_mf_fig_num); ?>" class="form-control" required placeholder="Enter Fig Num">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <input type="text" readonly name="num_parts" value="<?php echo e($product->lego_mf_num_parts); ?>" class="form-control" required placeholder="Enter Num Parts">
                                </div>
...
<?php echo $__env->make('layouts.contributor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/contributor/lego_minifigures/edit.blade.php ENDPATH**/ ?>