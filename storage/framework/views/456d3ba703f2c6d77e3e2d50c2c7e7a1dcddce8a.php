...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 text-right pb-4 ">
               <a href="<?php echo e(route('contributor_hottoys.index')); ?>">
        ...
        <div class="col-lg-12 mb-2">
            ...
            <?php endif; ?> 
            <?php echo $__env->make('contributor.partials.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>           
        </div>
        ...
        <div class="col-xl-12 ">
            <div class="row card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        <form action="<?php echo e(route('contributor_hottoys.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row px-4">
                                <div class="col-sm-4 p-1">
                                    ...
                                    <input type="text" name="name" readonly value="<?php echo e($product->name); ?>" class="form-control" required placeholder="Enter Product Name">
                                </div>
                                <div class="col-sm-4 p-1">
                                ...
                                <div class="col-sm-4 p-1">
                                    ...
                                    <input type="text" name="model_name" readonly value="<?php echo e($product->model_name); ?>" class="form-control" required placeholder="Enter Model Name">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="year">Year</label>
                                    <input type="text" name="year" readonly value="<?php echo e($product->year); ?>" class="form-control" required placeholder="Enter Year">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="collection_name">Collection Name</label>
                                    <input type="text" name="collection_name" readonly readonly value="<?php echo e($product->collection_name); ?>" class="form-control" required placeholder="Enter Collection Name">
                                </div>
...
<?php echo $__env->make('layouts.contributor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/contributor/hottoys/edit.blade.php ENDPATH**/ ?>