    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center p-4">
                <h3 class="m-0 font-weight-bold text-primary">All Premium Users</h3>
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <a href="<?php echo e(route('admin.user.show', $user->id)); ?>">
                                    ...
                                    src="<?php echo e(asset($user->image)); ?>" alt="user image">
                                </a>
                            </div>
                            <div class="row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/admin/users/premium.blade.php ENDPATH**/ ?>