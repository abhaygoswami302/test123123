						...
						<div class="row justify-content-center">
							<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
								<div class="Price1">
                                    ...
                                    <div class="PriceBtn">
										<a href="<?php echo e(route('register', [1, 2])); ?>">Sign Up</a>
									</div>
								</div>
							</div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
								<div class="Price1">
									...
									<div class="PriceBtn">
										<a href="<?php echo e(route('register', [2, 2])); ?>">Sign Up</a>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
								<div class="Price1 Price2">
									...
									<div class="PriceBtn">
										<a href="<?php echo e(route('register', [3, 3])); ?>">Sign Up</a>
									</div>
								</div>
							</div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
								<div class="Price1 Price2">
									...
									<div class="PriceBtn">
										<a href="<?php echo e(route('register', [4, 3])); ?>">Sign Up</a>
									</div>
								</div>
							</div>
						</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/auth/pricing.blade.php ENDPATH**/ ?>