...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 ">
            <h3 class="m-0 font-weight-bold text-primary">Add New Hot Toys Products</h3>
        </div>
            ...
            <div class="row card shadow mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Add New Hot Toys Product
                    </h6>
                </div>
                <div class="card-body">
                <div class="col-sm-12">
                    <form action="<?php echo e(route('hotToys.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row px-4">
                            ...
                            <div class="col-sm-12 p-1">
                                ...
                                <textarea name="notes" id="editor" cols="30" rows="3" class="form-control">
                                </textarea>
                            </div>
                            <div class="col-sm-4 p-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucc\resources\views/admin/hottoys/products/create.blade.php ENDPATH**/ ?>