        ...
        <div class="col-sm-12">
            <div class="row p-2">
                ...
                <div class="col-sm-6 text-center">
                    <h3 class="m-0 font-weight-bold text-primary">All Visible Products</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($product->visibility == '0'): ?>
                                        Hidden
                                    <?php else: ?>
                                        <div class="alert alert-primary">Visible</div>
                                    <?php endif; ?>    
                                </td>  
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ultimatecollectionscompany.com/public_html/test123/resources/views/admin/dashboard/visible_products.blade.php ENDPATH**/ ?>