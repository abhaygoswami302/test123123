    ...
    <div class="row bg-container">
              ...
              <div class="ClctMnRt tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                  <div class="ClctMnRtTp ProductWtBdcrm">
                    <div class="ClctMnRtTpLft">
                        <div class="TitleMn">
                          <h2>Edit {{ ucfirst($temp->name) }} Product</h2>
                        </div>
                    </div>
                    <div class="ClctMnRtTpRt">
                        <ul class="breadcrumb">
                            <li><a class="active" href="{{ route('users.dashboard') }}">Home</a></li>
                            <li><a class="active" href="{{ route('tempIndex') }}">CSV Upload</a></li>
        ...
        <div class="col-xl-12 ">   
            @if (Session::get('productform'))
                ...
                @endif                 
            <form action="{{ route('tempEdit', $temp->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row p-2">
                    <div class="col-sm-3">
                ...
                <div class="row p-2">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control" name="colour" wire:model="colour" placeholder="Enter Colour" value="{{ $temp->colour }}" required>
