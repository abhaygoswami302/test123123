...
<div class="container">
    <div class="row bg-container p-4">
        <div class="col-lg-3 p-2">
            @if (count($temporaries) > 0)
            <a href="{{ route('tempLoadProducts') }}" style="text-decoration: none">
                <button class="btn btn-danger my-2 animated bounce infinite">Upload Products</button> 
            </a>
            <button class="btn btn-outline-info my-2" data-toggle="modal" data-target="#exampleModal">Help</button>
            @else
            <button class="btn btn-danger text-white my-2" data-toggle="modal" data-target="#exampleModal">Help</button>
            <!-- Modal -->
        ...
        <div class="col-lg-12 my-4">
            <div class="card table-responsive my-2">
                @if (count($temporaries) > 0)
                <div class="card-header">Temporary Products <small> (Click On <b>Upload Products</b> To Add These Temporary Products In Database)</small> </div>
                <table class="card-body table table-hover table-striped table-bordered ">
                    ...
                    <tbody>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <p>
                                    <h4 class="alert alert-info text-center">No Temporary Products Exist!</h4>
                                </p>
                            </div>
                        </div>
                        @endforelse
