                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="row">
                                        <div class="col-sm-6 text-center">
                                            <a href="{{ route('contributor_products.edit', $product->id) }}"><i class="fas fa-edit"></i></a>
                                        </div>
                                        <div class="col-sm-6 text-center">
                                            <a href="{{ route('contributor_products.show', $product->id) }}"><i class="fas fa-paper-plane"></i></a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('contributor_products.show', $product->id) }}">
                                        {{ $product->name }}
                                    </a>
                                </td>
                                <td>
