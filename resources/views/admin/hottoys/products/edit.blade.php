    ...
    <div class="row">
        ...
        <div class="col-xl-12 ">
            <div class="row card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        <form action="{{ route('hotToys.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row px-4">
                                ...
                                <div class="col-sm-4 p-1">
                                    ...
                                    <input type="text" name="model_name"  value="{{ $product->model_name }}" class="form-control" required placeholder="Enter Model Name">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="year">Year</label>
                                    <input type="text" name="year"  value="{{ $product->year }}" class="form-control" required placeholder="Enter Year">
                                </div>
                                <div class="col-sm-4 p-1">
                                    <label for="collection_name">Collection Name</label>
                                    <input type="text" name="collection_name" readonly value="{{ $product->collection_name }}" class="form-control" required placeholder="Enter Collection Name">
                                </div>

                                <div class="col-sm-6 p-1">
                                    <label for="toy_hash">Toy Hash</label>
                                    <input type="text" name="toy_hash" value="{{ $product->toy_hash }}" class="form-control" required placeholder="Enter Fig Num">
                                </div>
                                <div class="col-sm-6 p-1">
