        ...
        <div class="col-lg-8 mb-4 offset-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add New Collection</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin_collections.store') }}" method="POST" class="user" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <input type="submit" value="Add New Collection" class="btn btn-primary btn-user btn-block">
                            </div>
                        </div> 
                    </form>
                </div>
