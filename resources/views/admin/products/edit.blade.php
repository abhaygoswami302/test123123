    ...
    <div class="row bg-container">
        <div class="col-lg-12 text-center p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('admin_products.index') }}">Products</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit Product</li>
                </ol>
            </nav>
        </div>

        <div class="col-xl-12">@include('admin.partials.alert')</div>

        <div class="col-xl-12 card shadow">   
            <div class="card-header text-primary">Edit Product</div>
            <div class="card-body">
            <form action="{{ route('admin_products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row p-2">
                    <div class="col-sm-3">
