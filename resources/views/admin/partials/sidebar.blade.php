...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseCSVs" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin.csv.create') }}">Hot Wheels CSV Upload</a>
                <a class="collapse-item text-wrap" href="{{ route('lego_minifigures.create') }}">Lego Minifigures CSV Upload</a>
                <a class="collapse-item text-wrap" href="{{ route('hotToysCsv.create') }}">Hot Toys CSV Upload</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_products.index') }}">View Hot Wheels Products</a>
                <a class="collapse-item text-wrap" href="{{ route('lego_minifigures_form.index') }}">View Lego Minifigures Products</a>
                <a class="collapse-item text-wrap" href="{{ route('hotToys.index') }}">View Hot Toys Products</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">My Products:</h6>
                <a class="collapse-item text-wrap" href="{{ route('admin_products.create') }}">Add New Hot Wheels Product</a>
                <a class="collapse-item text-wrap" href="{{ route('lego_minifigures_form.create') }}">Add New Lego MiniFigures Product</a>
                <a class="collapse-item text-wrap" href="{{ route('hotToys.create') }}">Add New Hot Toys Product</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_collections.index') }}">View Collections</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_collections.create') }}">Add New Collection</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCategory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_categories.index') }}">View Categories</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_categories.create') }}">Add New Category</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSeries" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_series.index') }}">View Subseries</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_series.create') }}">Add New Subseries</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseMainlineseries" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_mainline.index') }}">View Mainline Series</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_mainline.create') }}">Add New Mainline Series</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCasting" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_castings.index') }}">View Castings</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_castings.create') }}">Add New Casting</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTheme" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin_themes.index') }}">View Theme</a>
                <a class="collapse-item text-wrap" href="{{ route('admin_themes.create') }}">Add New Theme</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-wrap" href="{{ route('admin.users.index') }}">All Users</a>
                <a class="collapse-item text-wrap" href="{{ route('admin.users.create') }}">Add New User</a>
            </div>
        </div>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.user.premium') }}">
            <i class="fas fa-fw fa-user-shield"></i>
            <span>Premium Users</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.user.standard') }}">
            <i class="fas fa-fw fa-user-tie"></i>
            <span>Standard Users</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin_editor.index') }}">
            <i class="fas fa-fw fa-user-tie"></i>
            <span>Editors</span></a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin_contributor.index') }}">
            <i class="fas fa-fw fa-user-tie"></i>
    ...
    <div class="text-center d-none d-md-inline pt-2">
        <a href="{{ route('clearProducts.index') }}" onclick="return confirm('Are You Sure You Want To Clear Products Database?');">
