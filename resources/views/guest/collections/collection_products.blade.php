						...
						<!--p>Total <b>2</b> Collections | <b>2</b>  in this page</p-->
                            ...
                            <div class="col-xl-12 text-center">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a class="active" href="{{ route('collection.index') }}">{{ $collection->name }}</a></li>
                                    <li><a class="active" href="{{ route('collection.show', $collection->id) }}">Categories</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {{ substr($category->description, 0, 30) }}...                        
                    @endif
                </div>
            </div>
