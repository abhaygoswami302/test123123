<div class="col-sm-12">
    ...
    @if ($toggle == 1)
        <div class="alert alert-success flash animated ">
            ...
            <a href="{{ route('userproduct.index') }}"><small>View My Products Collection</small></a>
        </div>
    @endif
    @if ($toggle == 0)
    <div class="alert alert-danger flash animated ">
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <div class="">
                ...
                @if ($flag == 0)
                <button class="btn  py-2 " style="border: 1px solid rgb(180, 180, 180);color:rgb(97, 97, 97)"  wire:click="save({{ $product }})" 
                type="button"> Add To Collection </button>
                <!--i class="far fa-2x fa-heart"style="cursor:pointer;color:rgb(251, 40, 54);"></i-->
                @else
                <!--i class="fas fa-2x fa-heart" wire:click="save({{ $product }})" style="cursor:pointer;color:rgb(251, 40, 54);"></i-->
                <button class="btn  py-2 " style="background:lightgreen;border: 1px solid rgb(180, 180, 180);color:rgb(63, 62, 62)"  wire:click="save({{ $product }})" 
