...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
       ...
       <div class="div">
        <a href="{{ route('editor_products.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4 my-card">
                ...
                <div class="card-body">
                    ...
                    <a rel="nofollow" href="{{ route('editor_products.index') }}">Browse All Products &rarr;</a>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow mb-4 my-card">
                ...
                <div class="card-body">
                    ...
                    <!--p>Add some quality, svg illustrations to your project courtesy of <a
                        ...
                        constantly updated collection of beautiful svg images that you can 
                        completely free and without attribution!</p-->
                    <a rel="nofollow" href="{{ route('editor_products.create') }}">Add New Product &rarr;</a>
                </div>
            </div>
        </div>
