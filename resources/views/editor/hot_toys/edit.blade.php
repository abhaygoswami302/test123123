...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 text-right pb-4 ">
               <a href="{{ route('editor_hot_toys.create') }}">
                <button class="btn btn-primary btn-sm">Add New Hot Toys Product</button>
               </a>
               <a href="{{ route('editor_hot_toys.index') }}">
        ...
        <div class="col-xl-12 ">
            <div class="row card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="col-sm-12">
                        <form action="{{ route('editor_hot_toys.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
