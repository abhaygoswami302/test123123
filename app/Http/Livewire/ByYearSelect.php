...
class ByYearSelect extends Component

{
...

    {
        ...
        return view('livewire.by-year-select', ['products' => 

                                    Product::where('year', '=', $this->year)
...

    {
        ...
        if($value){
            ...
            $this->selectedProducts = Product::where('year', '=', $this->year)
