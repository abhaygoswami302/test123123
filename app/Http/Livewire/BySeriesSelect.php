...
class BySeriesSelect extends Component

{
...

    {
        ...
        return view('livewire.by-series-select', ['products' => 

                                    Product::where('series', '=', $this->series)
...

    {
        ...
        if($value){
            ...
            $this->selectedProducts = Product::where('series', '=', $this->series)
