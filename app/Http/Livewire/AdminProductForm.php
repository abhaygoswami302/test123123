...
class AdminProductForm extends Component
{
    ...
    {
        $this->categories = Category::where('name', '<>', 'Lego MiniFigures')->orderBy('name')->get();
    ...
    public function render()
    {
        ...
        return view('livewire.admin-product-form', ['themes' => $themes]);
    }
    ...
    public function render()
    {
        $this->themes = Theme::orderBy('name')->get();
        return view('livewire.admin-product-form', ['themes' => $this->themes]);
    }
    ...
    public function updatedSelectedSeries($series)
    {
        ...
        if (!is_null($series)) {
            $this->sub = Subseries::where('id', $series)->first();
            $this->mycasting = Casting::where('subseries_id', '=', $this->sub->id)->get();
            $this->casting_name =  $this->mycasting;
