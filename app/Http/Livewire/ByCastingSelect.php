...
class ByCastingSelect extends Component
{
    public $casting;
    ...
    public function render()
    {
        ...
        return view('livewire.by-casting-select', ['products' => 
                                    Product::where('casting_name', '=', $this->casting)
    ...
    {
        if($value){
            $this->selectedProducts = Product::where('casting_name', '=', $this->casting)
