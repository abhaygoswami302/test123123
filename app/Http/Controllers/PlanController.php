...
class PlanController extends Controller
{
    public function createPlan()
    {
        ...
        $plan->setName('Premium Yearly Plan')
            ->setDescription('Yearly Premium Plan')
            ->setType('fixed');

        $paymentDefinition = new PaymentDefinition();

        $paymentDefinition->setName('Regular Payments Each Year')
            ->setType('REGULAR')
            ->setFrequency('Year')
            ->setFrequencyInterval("1")
            ->setCycles("1")
            ->setAmount(new Currency(array('value' => 150, 'currency' => 'AUD')));
        ...
        $merchantPreferences->setReturnUrl("https://ultimatecollectionscompany.com/test123/execute-agreement/true")
            ->setCancelUrl("https://ultimatecollectionscompany.com/test123/execute-agreement/false")
