...
class UpgradePlanController extends Controller
{
    ...
    public function create($flag1, $flag2)
    {
        return redirect()->route('user_upgradePlan.register', [$flag1, $flag2]);
    }

    public function register($flag1, $flag2)
    {
        return view('user.plan.register', compact('flag1', 'flag2'));
    }
