...
class EditorProductsController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('editor.products.create', compact('categories', 'subseries', 'themes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with([
            'editor_product_added'=> 'Product Added Successfully',
