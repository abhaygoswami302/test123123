...
class ContributorProductsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('contributor.dashboard', compact('products'));
    }
    ...
    public function show($id)
    {
        ...
        return view('contributor.products.show', compact('product'));
    }
    ...
    {
        $product = Product::where('id', '=', $id)->first();
        return view('contributor.products.edit', compact('product'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      if($product_toy_hash <> null){
        ...
        return redirect()->back()->with([
            'contributor_products_edit'=> 'Product Images Edited Successfully',
