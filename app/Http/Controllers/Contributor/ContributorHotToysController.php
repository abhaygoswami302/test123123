...
class ContributorHotToysController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('contributor.hottoys.index', compact('products'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('contributor.hottoys.edit', compact('product', 'categories', 'subseries'));
    }
