...
class HotToysController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.hottoys.products.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.hottoys.products.create', compact('categories', 'subseries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hotToys.create')->with('message', 'Product Added Successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.hottoys.products.edit', compact('product', 'categories', 'subseries'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      /*  $temppp = Product::where('toy_hash', '=', $request->toy_hash)
