...
class AdminLegoMiniFiguresFormController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.lego_minifigures.index', compact('products'));
    ...
    {
        return view('admin.lego_minifigures.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lego_minifigures_form.create')->with('message', 'Lego MiniFigures Product Created successfully');
    ...
    public function edit($id)
    {
        ...
        return view('admin.lego_minifigures.edit', compact('product'));
    }
